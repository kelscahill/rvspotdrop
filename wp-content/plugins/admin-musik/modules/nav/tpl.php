	...
	<p>
		<label style="margin-right:10px">
			<input name="<?php echo $this->setting->setting_name; ?>[bar_front]" type="checkbox" <?php if ($this->setting->get_setting('bar_front') == true) echo 'checked="checked" '; ?>> 
			Apply style on front-end 
		</label>
	</p>
	<div class="box">
	...
	<div class="clearfix admin-menus">
			...
			<div id="dropdown" class="dropdown box">
				<div class="box-body" id="tab-iconlist">
					<div class="clearfix">
						<ul class="subsubsub">
							<li><a href="#tab-dashicons" class="current">Dashicons</a> | </li>
							<li><a href="#tab-icons">Icons</a></li>
						</ul>
					</div>
