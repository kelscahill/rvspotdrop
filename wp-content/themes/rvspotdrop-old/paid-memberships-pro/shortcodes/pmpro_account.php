...
function my_pmpro_shortcode_account($atts, $content=null, $code="")
{
	...
	<div id="pmpro_account">
		...
		<div class="membership-top-inner">
...
<?php if(in_array('profile', $sections)) { ?>
			<div id="pmpro_account-profile" class="<?php echo pmpro_get_element_class( 'pmpro_box', 'pmpro_account-profile' ); ?>">
				...
				<div class="<?php echo pmpro_get_element_class( 'pmpro_actionlinks' ); ?>">
					<?php
						...
						?> <a href="<?php echo site_url()?>/my-membership-profile/">My Membership Profile</a> | <?php
		...
		<?php if(in_array('membership', $sections) || in_array('memberships', $sections)) { ?>
			<div id="pmpro_account-membership" class="<?php echo pmpro_get_element_class( 'pmpro_box', 'pmpro_account-membership' ); ?>">
							...
							<tr>
								<td class="<?php echo pmpro_get_element_class( 'pmpro_account-membership-levelname' ); ?>">
									...
									<div class="<?php echo pmpro_get_element_class( 'pmpro_actionlinks' ); ?>">
										...
										$pmpro_member_action_links['cancel'] = sprintf( '<a id="pmpro_actionlink-cancel" href="%s">%s</a>', esc_url( add_query_arg( 'levelstocancel', $level->id, pmpro_url( 'cancel' ) ) ), esc_html__( 'Delete My Membership Profile', 'paid-memberships-pro' ) );
				...
				<div class="<?php echo pmpro_get_element_class( 'pmpro_actionlinks' ); ?> pmpro_actionlinks-options">
		...
		<div id="pmpro_account-invoices" class="pmpro_account-invoices-p <?php echo pmpro_get_element_class( 'pmpro_box', 'pmpro_account-invoices' ); ?>">
...
add_shortcode('pmpro_account_new', 'my_pmpro_shortcode_account');
