	...
	<?php
		if(!$pmpro_confirm)
		{
			...
			<div class="<?php echo pmpro_get_element_class( 'pmpro_actionlinks' ); ?>">
				<a class="<?php echo pmpro_get_element_class( 'pmpro_btn pmpro_btn-submit pmpro_yeslink yeslink', 'pmpro_btn-submit' ); ?>" href="<?php echo pmpro_url("cancel", "?levelstocancel=" . esc_attr($_REQUEST['levelstocancel']) . "&confirm=true")?>"><?php _e('Yes, Delete My Membership Profile', 'paid-memberships-pro' );?></a>
