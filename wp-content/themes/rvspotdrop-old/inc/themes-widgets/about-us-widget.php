...
class rvspotdrop_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'rvspotdrop_About_Widget',
			__('VW About us', 'rvspotdrop'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'rvspotdrop' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','rvspotdrop'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','rvspotdrop'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','rvspotdrop'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','rvspotdrop'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','rvspotdrop'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','rvspotdrop'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function rvspotdrop_about_custom_load_widget() {
	register_widget( 'rvspotdrop_About_Widget' );
}
add_action( 'widgets_init', 'rvspotdrop_about_custom_load_widget' );