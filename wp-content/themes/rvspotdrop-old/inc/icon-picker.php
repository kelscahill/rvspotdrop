...
class rvspotdrop_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
        <label>
            ...
            <ul class="icon-list clearfix">
                <?php
                $rvspotdrop_font_awesome_icon_array = rvspotdrop_font_awesome_icon_array();
                foreach ($rvspotdrop_font_awesome_icon_array as $rvspotdrop_font_awesome_icon) {
                        $icon_class = $this->value() == $rvspotdrop_font_awesome_icon ? 'icon-active' : '';
                        echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($rvspotdrop_font_awesome_icon).'"></i>
                        <span class="rvspotdrop-social-class">'.esc_attr($rvspotdrop_font_awesome_icon).'</span>
                        </li>';
                    }
                ?>
            </ul>
...
function rvspotdrop_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'rvspotdrop-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'rvspotdrop_customizer_script' );

if(!function_exists('rvspotdrop_font_awesome_icon_array')){
    function rvspotdrop_font_awesome_icon_array(){
