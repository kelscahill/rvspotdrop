...
if ( ! class_exists( 'rvspotdrop_Content_Creation' ) ) :

	/**
	 * rvspotdrop_Content_Creation class.
	 */
	class rvspotdrop_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * rvspotdrop_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'rvspotdrop_Content_Creation' );
