jQuery( document ).ready( function() {
	...
	wp.customize(
		'rvspotdrop_rvspotdrop_h4_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'rvspotdrop_rvspotdrop_h4_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'rvspotdrop_rvspotdrop_h4_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'rvspotdrop_rvspotdrop_h5_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'rvspotdrop_rvspotdrop_h5_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
